...
public interface ISdgRepository
{
    ...
    // Agency operations
    Task<int> GetOrCreateAgencyAsync(string agencyName, CancellationToken cancellationToken = default);
    Task<Dictionary<string, int>> GetExistingAgenciesAsync(CancellationToken cancellationToken = default);
